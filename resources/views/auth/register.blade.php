    ...
    <div class="container my-5">
        <div class="row justify-content-center align-items-center">
            <div class="col-12 col-md-8">
                <form action="{{route('register')}}" method="POST" class="clard p-5 shadow">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3 d-flex justify-content-center flex-column aling-items-center">
                        <button type="sumbmit" class="btn btn-outline-primary">Registrati</button>
